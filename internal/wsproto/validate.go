...
var clientCommandTypes = map[string]bool{
	...
	TypeSetOrders:        true,
	TypeLockOrders:       true,
	TypeUnlockOrders:     true,
	TypeMapPing:          true,
	TypeProposalArrow:    true,
	TypeChatMessage:      true,
	TypeLeaveForNow:      true,
	TypeResignMatch:      true,
	TypeEndNoContest:     true,
	TypeKeepWaiting:      true,
	TypeRematchReady:     true,
	TypeStartRematch:     true,
	TypeReturnToLobby:    true,
	TypeClaimSeat:        true,
	TypeRemovePlayer:     true,
	TypeResync:           true,
	TypeVoiceJoin:        true,
	TypeVoiceLeave:       true,
