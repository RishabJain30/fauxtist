...
export default function GameOver({ state, meId, send, onLeave, disabled }) {
  ...
  return (
    <div className="card col pop-in" style={{ textAlign: 'center', alignItems: 'center' }}>
      ...
      {isHost
        ? <button className="btn-primary" onClick={() => send('new_game')} disabled={disabled}>🔄 Start a new game</button>
